    ...
    '
      {
        ...
        bindings: [
          ...
          {binding_id: "storage-app", provider: "azure-app-service-settings", location: "azure", management: "update-and-verify", scope_id: $app_service_id, key_resource_id: $storage_id, key_slot: "key1", selectors: ["AZURATOR_STORAGE_ALIAS", "AZURATOR_STORAGE_KEY"]},
